...
const guides = [
  ...
  },
  {
    ...
    certifications: ["Mountain Guide Certification", "Wilderness First Responder"],
    experience: [
      {
  ...
  },
  {
    ...
    certifications: ["Cultural Sensitivity Training", "Textile Arts Certification"],
    experience: [
      {
        title: "Founder & Guide",
    ...
    reviewsList: [
      ...
      },
      {
        author: "Rachel M.",
        rating: 5,
        comment: "Unique perspective on Moroccan culture we wouldn't have gotten otherwise.",
        date: "2023-09-30"
      }
    ],
    stats: {
  ...
  },
  {
    ...
    certifications: ["Professional Photography Degree", "Drone Operation License"],
    experience: [
      {
  ...
  },
  {
    ...
    gallery: [
      "/images/gallery/guide8-1.jpg",
      "/images/gallery/guide8-2.jpg"
    ]
  },
  {
    id: 9,
    ...
    reviewsList: [
      ...
      },
      {
        author: "Anna K.",
        rating: 5,
        comment: "Perfect for adrenaline junkies - felt completely safe the whole time.",
        date: "2023-09-18"
      }
    ],
    stats: {
        ...
        <div className="grid mt-5 grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <a href={`tel:${guide.contact.phone}`} className="hover:text-blue-600 transition">
                    {guide.contact.phone}
                  </a>
                </div>
                <div className="flex items-center">
                  <FaEnvelope className="text-gray-500 mr-3" />
                  <a href={`mailto:${guide.contact.email}`} className="hover:text-blue-600 transition">
                    {guide.contact.email}
                  </a>
                </div>
                <div className="flex items-center">
                  <FaGlobe className="text-gray-500 mr-3" />
                  <a href={`https://${guide.contact.website}`} target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition">
          ...
          <div className="lg:col-span-2">
            ...
            <motion.div
              ...
              className="bg-white rounded-xl shadow-lg overflow-hidden p-6 mb-6"
            >
              <h2 className="text-2xl font-bold mb-4">Experience & Certifications</h2>
              
              <div className="experience-timeline mt-6">
                {guide.experience.map((exp, i) => (
                  <div key={i} className="timeline-item relative pl-8 pb-6 border-l-2 border-blue-200">
                    ...
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="flex items-center">
                        {[...Array(5)].map((_, starIdx) => (
                          <FaStar 
                            key={starIdx} 
                            className={`${starIdx < review.rating ? 'text-amber-400' : 'text-gray-300'}`}
                          />
                        ))}
                      </div>
                    </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="stat-card bg-blue-50 p-6 rounded-lg text-center">
                  ...
                  <h3 className="font-bold text-2xl">{guide.stats.toursCompleted}</h3>
                ...
                <div className="stat-card bg-green-50 p-6 rounded-lg text-center">
                  ...
                  <h3 className="font-bold text-2xl">{guide.stats.repeatClients}%</h3>
                ...
                <div className="stat-card bg-amber-50 p-6 rounded-lg text-center">
                  ...
                  <h3 className="font-bold text-2xl">{guide.stats.responseRate}</h3>

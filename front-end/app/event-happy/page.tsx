  ...
  const events = [
    {
      ...
      season: 'Summer',
      image: '/images/events/gnaoua-festival.jpg',
      description: 'Experience the magical fusion of Gnaoua music with international jazz, blues, and pop artists.',
      price: 'From 200 AED'
    },
    {
      id: 2,
      ...
      season: 'Winter',
      image: '/images/events/film-festival.jpg',
      description: 'Red carpet premieres and screenings with international film stars in historic Marrakech.',
      price: 'From 350 AED'
    },
    {
      id: 3,
      ...
      description: 'Celebration of Saharan nomadic culture with camel races, traditional music, and poetry.',
      price: 'Free'
    },
    {
      id: 4,
      ...
      description: 'Spiritual music from around the world in the ancient medina of Fes.',
      price: 'From 250 AED'
    },
    {
      id: 5,
      ...
      season: 'Spring',
      image: '/images/events/rose-festival.jpg',
      description: 'Celebration of the valley\'s rose harvest with parades, music, and local products.',
      price: 'Free'
    },
    {
      id: 6,
      ...
      description: 'The toughest footrace on Earth - 250km through the Sahara Desert.',
      price: 'Registration required'
    }
  ];

  const seasons = ['All', 'Spring', 'Summer', 'Fall', 'Winter'];
  const categories = ['All', 'Music', 'Film', 'Cultural', 'Sports', 'Religious'];
  const cities = ['All', 'Marrakech', 'Fes', 'Essaouira', 'Tan-Tan', 'Kelaat M\'Gouna', 'Sahara Desert'];

  const filteredEvents = events.filter(event => {
    const matchesSeason = activeSeason === 'All' || event.season === activeSeason;
    ...
    <div className="events-page">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
              Discover cultural festivals, music celebrations, and unique happenings across the kingdom
            </p>
            <motion.button
      ...
      <section className="py-12 bg-gradient-to-r from-blue-50 to-amber-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">Find Your Perfect Event</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Season Filter */}
              <div>
                <h3 className="text-lg font-semibold mb-3 text-gray-700">Season</h3>
                <div className="flex flex-wrap gap-2">
                  {seasons.map(season => (
                    <motion.button
                      key={season}
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeSeason === season ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {categories.map(category => (
                    <motion.button
                      key={category}
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeCategory === category ? 'bg-amber-600 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
              ...
              {/* City Filter */}
              <div>
                <h3 className="text-lg font-semibold mb-3 text-gray-700">City</h3>
                <div className="flex flex-wrap gap-2">
                  {cities.map(city => (
                    <motion.button
                      key={city}
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeCity === city ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
            ...
            {/* Active Filters */}
            {(activeSeason !== 'All' || activeCategory !== 'All' || activeCity !== 'All') && (
              <motion.div 
                  ...
                  <div className="event-card bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 h-full flex flex-col">
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                        ...
                        <span className="text-white block text-sm">{event.date}</span>
                      </div>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-50 to-amber-50">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Event Locations</h2>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Experience Our Events</h2>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-50 to-amber-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Visitor Experiences</h2>
            ...
            {[
              {
                ...
                comment: "The Gnaoua Festival was life-changing! The music, the energy, the people - unforgettable.",
                rating: 5,
              ...
              },
              {
                ...
                comment: "Attending the Marrakech Film Festival gave me access to incredible films and celebrities.",
                rating: 4,
              ...
              },
              {
                ...
                comment: "The Rose Festival was more beautiful than I imagined. The scent of roses everywhere!",
                rating: 5,
                event: "Rose Festival"
              }
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <p className="text-center mb-8 text-blue-100 max-w-2xl mx-auto">
              Sign up to receive notifications about upcoming events and exclusive offers
            </p>

...
// import "../styles/GuidesSection.css"; // Our custom CSS file
...
//                       {[...Array(5)].map((_, i) => (
//                         <span key={i} className={`star ${i < Math.floor(guide.rating) ? 'filled' : ''}`}>★</span>
//                       ))}
...
//                         <span key={i} className="specialty">{spec}</span>
//                       ))}
//                     </div>
//                   </div>
//                 </div>
...
//                       <p><span className="icon">✉️</span> {guide.email}</p>
//                       <p><span className="icon">📞</span> {guide.phone}</p>
//                     </div>
//                     <p className="bio">{guide.bio}</p>
//                     <div className="action-buttons">
//                       <Link href={`/guides/${guide.id}`} className="profile-link">
//                         View Full Profile
//                       </Link>
//                     </div>
//                   </div>

            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  accept="image/*"
                  onChange={handleFileChange}
                  className="w-full p-3 rounded-lg border focus:outline-none file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold transition-all duration-200"
                  style={{
                    borderColor: `${colors.border}40`,
                    backgroundColor: '#1E1E1E',
                    color: colors.text,
